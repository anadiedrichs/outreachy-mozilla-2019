...
The following line create a complited EDA report for the dataset. It took a while to run in a PC celeron computer. The report is saved as `r print(report_name)`
